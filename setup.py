...
setup(
    ...
    version='1.6.7c',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/aitirga/pydelling/archive/refs/tags/v_1.6.7.zip',  # I explain this later on
