...
class LumiSsh(BaseSsh):
    ...
    def __init__(self,
        ...
        self.user_path = f"/home/{self.user}"
        self.project_path = f"{self.user_path}/{self.project_folder_name}"
        self.scratch_path = f"/scratch/{self.project_folder_name}"
        self.flash_path = f"/flash/{self.project_folder_name}"
    ...
    def cd_project(self):
        ...
        """
        self.cd(self.project_path)

    def cd_scratch(self):
        """
        Changes the current working directory to the scratch directory in the remote server.
        """
        self.cd(self.scratch_path)

    def cd_flash(self):
        """
        Changes the current working directory to the flash directory in the remote server.
        """
        self.cd(self.flash_path)
